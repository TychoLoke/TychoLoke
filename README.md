...
- [saas-ai-command-center](https://github.com/TychoLoke/saas-ai-command-center): an AI-native SaaS starter with a polished Next.js product shell, OpenAI workflow route, and billing-ready Prisma model.
